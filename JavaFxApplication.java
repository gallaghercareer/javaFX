...
Purpose: Java GUI application that allows a user to login. The program will log the success/fail of the login attempt 
as well as the user and timestamp. The program also sends the user an email with a randomly generated number that 
will be required to dual-authenticate the login. 
